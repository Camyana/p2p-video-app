...
class SignalingServer {
    constructor(port = 3001) {
        ...
        this.hostingUsers = new Map(); // IP -> socketId mapping
        this.socketToIP = new Map(); // socketId -> IP mapping
        this.ipToSockets = new Map(); // IP -> array of socketIds (for local testing)
        this.port = port;
