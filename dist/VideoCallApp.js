...
const VideoCallApp = () => {
    ...
    const currentRoomIdRef = (0, react_1.useRef)(''); // Add ref for currentRoomId to avoid timing issues
    // Update state
    const [appVersion, setAppVersion] = (0, react_1.useState)('');
    const [isCheckingForUpdates, setIsCheckingForUpdates] = (0, react_1.useState)(false);
    ...
    // Render functions
    const renderConnectScreen = () => ((0, jsx_runtime_1.jsx)("div", { className: "flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white p-8", children: (0, jsx_runtime_1.jsxs)("div", { className: "bg-slate-800/50 backdrop-blur-lg rounded-xl p-8 w-full max-w-md border border-slate-700/50", children: [(0, jsx_runtime_1.jsxs)("div", { className: "text-center mb-8", children: [(0, jsx_runtime_1.jsx)(react_fontawesome_1.FontAwesomeIcon, { icon: free_solid_svg_icons_1.faServer, className: "text-4xl text-blue-400 mb-4" }), (0, jsx_runtime_1.jsx)("h1", { className: "text-2xl font-bold mb-2", children: "P2P Video Call" }), (0, jsx_runtime_1.jsx)("p", { className: "text-slate-300", children: "Connect to a signaling server to start" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "space-y-4", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("label", { className: "block text-sm font-medium mb-2", children: "Your Name" }), (0, jsx_runtime_1.jsx)("input", { type: "text", value: userName, onChange: (e) => setUserName(e.target.value), className: "w-full p-3 bg-slate-700/50 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:border-blue-400 focus:outline-none", placeholder: "Enter your name" })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("label", { className: "block text-sm font-medium mb-2", children: "Server URL" }), (0, jsx_runtime_1.jsx)("input", { type: "text", value: signalingServerURL, onChange: (e) => setSignalingServerURL(e.target.value), className: "w-full p-3 bg-slate-700/50 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:border-blue-400 focus:outline-none", placeholder: "localhost:3001" })] }), (0, jsx_runtime_1.jsx)("button", { onClick: connectToServer, disabled: !userName.trim() || !signalingServerURL.trim(), className: "w-full bg-blue-600 hover:bg-blue-700 disabled:bg-slate-600 disabled:cursor-not-allowed text-white font-medium py-3 px-6 rounded-lg transition-colors", children: "Connect to Server" }), connectionStatus && ((0, jsx_runtime_1.jsx)("div", { className: "text-center text-sm text-slate-300 mt-4", children: connectionStatus }))] }), (0, jsx_runtime_1.jsxs)("div", { className: "mt-8 pt-6 border-t border-slate-700/50", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between mb-4", children: [(0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsxs)("p", { className: "text-sm text-slate-400", children: ["Version: ", appVersion] }) }), (0, jsx_runtime_1.jsxs)("button", { onClick: checkForUpdates, disabled: isCheckingForUpdates, className: "bg-slate-700 hover:bg-slate-600 disabled:bg-slate-700 disabled:cursor-not-allowed text-white text-sm font-medium py-2 px-4 rounded-lg transition-colors flex items-center gap-2", children: [(0, jsx_runtime_1.jsx)(react_fontawesome_1.FontAwesomeIcon, { icon: free_solid_svg_icons_1.faCog, className: `text-sm ${isCheckingForUpdates ? 'animate-spin' : ''}` }), isCheckingForUpdates ? 'Checking...' : 'Check for Updates'] })] }), updateStatus && ((0, jsx_runtime_1.jsx)("div", { className: "text-center text-sm text-slate-300", children: updateStatus }))] })] }) }));
